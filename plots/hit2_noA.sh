...
set title "Player Winning Probability in Blackjack (no Ace) - Hit twice"
...
set ticslevel 1.8
set isosample 40,40
set cntrparam levels discrete 0.1,0.2, 0.3

splot './hit2_noA.out' using 1:2:3 with lines notitle
