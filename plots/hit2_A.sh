...
set title "Player Winning Probability in Blackjack (Ace) - Hit twice"
...
set ticslevel 1.6
set isosample 40,40
set cntrparam levels discrete 0.3 , 0.4, 0.45

splot './hit2_A.out' using 1:2:3 with lines notitle
